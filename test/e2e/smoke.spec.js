...
test.describe("Basic Application Functionality", () => {
  ...
  test("should load JavaScript files and create global objects", async ({
    page,
  }) => {
    await page.goto("/");
  ...
  test("should have responsive layout with viewport meta tag", async ({
    page,
  }) => {
    await page.goto("/");
  ...
  test("should load loading overlay and hide it", async ({ page }) => {
    ...
    await page
      .waitForSelector('#loading-overlay[style*="display: none"]', {
        timeout: 10000,
      })
      .catch(() => {
